...
//			JLabel barcodeLabel = new JLabel("DuyPH-Barcode");
//			c.gridx = 0;
//			c.gridy = row;
...
//			
//			row = getLastRowIndex();
//			JLabel descriptionLabel = new JLabel("DuyPH-Description");
//			c.gridx = 0;
//			c.gridy = row;
...
//			
//			row = getLastRowIndex();
//			JLabel quantityLabel = new JLabel("DuyPH-Quantity");
//			c.gridx = 0;
//			c.gridy = row;
...
//			
//			row = getLastRowIndex();
//			JLabel weightLabel = new JLabel("DuyPH-Weight");
//			c.gridx = 0;
//			c.gridy = row;
...
//			
//			row = getLastRowIndex();
//			JLabel dimensionWidthLabel = new JLabel("DuyPH-Dimension Width");
//			c.gridx = 0;
//			c.gridy = row;
...
//			
//			row = getLastRowIndex();
//			JLabel dimensionHeightLabel = new JLabel("DuyPH-Dimension Height");
//			c.gridx = 0;
//			c.gridy = row;
...
//			
//			row = getLastRowIndex();
//			JLabel dimensionDepthLabel = new JLabel("DuyPH-Dimension Depth");
//			c.gridx = 0;
//			c.gridy = row;
